...
public static class mianshiBookProjectEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE mianshiBookProjectModuleExtensionConfigurator CLASS (in the Domain.Shared project)
